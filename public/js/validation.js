$(document).ready(function () {
    $('#itemSelect').change(function () {
        ...
        validation["quantity"] = ["^([1-5][0-9]|[1-9])$", "Please put in a quantity"];
        ...
        validation["weight"] = ["^(\\d+\\.\\d+|\\d+)$", "Weight must be a positive number"];
        ...
        validation["price"] = ["^(\\d+)(\\.(\\d{1,2}))?$", "Price must have positive value with 2 decimals maximum"];
