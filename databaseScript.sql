...
REPLACE INTO User (id, email, password, admin) values (1, 'client1@conushop.com', '$2y$10$CCdVyhydRyjluMY7/39VL.A1atziI7EAdRHhWyFkZyMKOfMlFl3GW', 0);
REPLACE INTO User (id, email, password, admin) values (2, 'client2@conushop.com', '$2y$10$CCdVyhydRyjluMY7/39VL.A1atziI7EAdRHhWyFkZyMKOfMlFl3GW', 0);
REPLACE INTO User (id, email, password, admin) values (3, 'client3@conushop.com', '$2y$10$CCdVyhydRyjluMY7/39VL.A1atziI7EAdRHhWyFkZyMKOfMlFl3GW', 0);
